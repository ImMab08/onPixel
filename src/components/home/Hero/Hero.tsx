...
export const Hero = () => {
  return (
    <section className="h-full w-full bg-black bg-grid-white/[0.2] relative flex items-center justify-center">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-black [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
      <div className="relative flex items-center justify-center text-hero md:mx-40">

        <div className="absolute inset-0 floating-animation w-[150px] h-[150px] top-[180px] left-10 opacity-[0.7]">
          <svg fill="#ccc" width="600" height="600" viewBox=".5 -.2 1023 1024.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="absolute inset-0 floating-animation w-[150px] h-[150px] top-[130px] left-[150px] opacity-[0.7]">
          <svg fill="#ccc" height="80" width="80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 141.53199999999998">
        ...
        <div className="absolute inset-0 floating-animation w-[150px] h-[150px] top-[290px] left-[70px] opacity-[0.7]">
          <svg fill="#ccc" height="80" width="80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 141.53199999999998">
